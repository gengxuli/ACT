...
```
**Note:** [The website of terra_incognita ]([https://beerys.github.io/CaltechCameraTraps/](https://lilablobssc.blob.core.windows.net/caltechcameratraps/eccv_18_all_images_sm.tar.gz)) is not authorization now.
